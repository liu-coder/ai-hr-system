...
public interface SalaryAIService {
     ...
     * @return 薪酬调整响应
     */
    SalaryAdjustmentResponseDto suggestSalaryAdjustment(SalaryAdjustmentRequestDto request);
     ...
     * @return 税务优化响应
     */
    TaxOptimizationResponseDto optimizeTax(TaxOptimizationRequestDto request);
     ...
     * @return 薪酬预测响应
     */
    SalaryPredictionResponseDto predictSalary(SalaryPredictionRequestDto request);
     ...
     * @return 薪酬异常检测响应
     */
    SalaryAnomalyDetectionResponseDto detectSalaryAnomalies(SalaryAnomalyDetectionRequestDto request);
}
